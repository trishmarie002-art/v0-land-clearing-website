...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Panel */}
      <div
        className={`absolute bottom-20 right-0 w-80 bg-card border border-border rounded-lg shadow-2xl overflow-hidden transition-all duration-300 origin-bottom-right ${
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <a
              ...
              className="flex items-center gap-3 w-full p-4 bg-primary/10 hover:bg-primary/20 border border-primary/30 rounded-lg transition-all group hover:scale-[1.02]"
            >
            ...
            <a
              ...
              className="flex items-center gap-3 w-full p-4 bg-secondary hover:bg-secondary/80 border border-border rounded-lg transition-all group hover:scale-[1.02]"
            >
              <div className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center transition-transform group-hover:scale-110">
      ...
      <Button
        ...
        size="lg"
        className={`w-16 h-16 rounded-full shadow-lg transition-all hover:scale-110 animate-bounce-in ${
          isOpen
