      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <Card className="bg-card border-border hover:border-primary/50 transition-all group h-full hover:-translate-y-2 hover:shadow-xl">
                <CardHeader>
                  <div className="w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-all group-hover:scale-110">
        ...
        {/* Service Area Note */}
        <div className="mt-16 bg-card border border-border rounded-lg p-8 text-center animate-on-scroll fade-in hover:border-primary/30 transition-colors">
