      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            {/* Accent box */}
            <div className="absolute -bottom-6 -right-6 bg-primary p-6 rounded-lg hidden md:block">
              <div className="text-center">
                <span className="block text-4xl font-bold text-primary-foreground font-[family-name:var(--font-display)]">15+</span>
